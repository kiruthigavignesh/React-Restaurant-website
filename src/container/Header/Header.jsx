...
const Header = () => (
  <div className="app_header appaboutbg app_wrapper section_padding" id="home">
    <div className="app_wrapper_info">
      <SubHeading title="Welcome To Glassy Restaurant" />
      <h1 className="app_header-h1">We Only Serve A Delicious Dishes</h1>
