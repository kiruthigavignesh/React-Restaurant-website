...
const AboutUs = () => (
  <div className="app_aboutus appaboutbg flex_center section_padding" id="about">
    ...
    <div className="app_aboutus-content flex_center">
      ...
      <div className="app_aboutus-content_history">
        ...
        <img src={images.spoon} alt="about_spoon" className="spoon_img" />
        <p className="p_opensans">Adipiscing tempus ullamcorper loortis odio tellus arcu volutpat. Risus placerat morbi volutpat habitasse interdum mi aliquam In sed odio nec aliquet.</p>
        <button type="button" className="custom_button">Know More</button>
      </div>
    </div>
  </div>
